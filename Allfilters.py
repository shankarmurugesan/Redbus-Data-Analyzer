...
def allfilterfunc():
    ...
    with col1:
        ...
        st.session_state['selected_state'] = selected_state  # Update session state
    ...
    with col2:
        ...
        st.session_state['selected_operator'] = selected_operator  # Update session state
    ...
    with col3:
        ...
        st.session_state['selected_route'] = selected_route  # Update session state
    ...
    with col4:
        ...
        st.session_state['selected_bus_fare'] = selected_bus_fare  # Update session state
    ...
    with col5:
        ...
        st.session_state['selected_departure_time'] = selected_departure_time  # Update session state
    ...
    with col6:
        ...
        st.session_state['selected_bus_type'] = selected_bus_type  # Update session state
    ...
    with col7:
        ...
        st.session_state['selected_ratings'] = selected_ratings  # Update session state
    ...
    with col8:
        ...
        st.session_state['selected_seats_avail'] = selected_seats_avail  # Update session state
